...
fig1.savefig('brian2_threepops6_differentPitch_Nperpop'+str(Nperpop)+'_gAMPA'+str(gAMPA1)+'-'+str(gAMPA2)+'_gNMDA'+str(gNMDA1)+'-'+str(gNMDA2)+'_gGABA'+str(gGABA)+'_'+str(tauD)+'_figs.pdf')
