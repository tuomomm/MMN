...
stimulus3 = TimedArray(array([0]*49+[0]+[0]*49+[0]+[0]*49+[0]+[0]*49+[120]+[0]*49+[0]+[0]*49+[0]+[0]*49+[0]+[0]*49+[0]+[0]*1000), dt=10*ms)
...
fig1.savefig('brian2_threepops6_soonerAndDifferentPitch_Nperpop'+str(Nperpop)+'_gAMPA'+str(gAMPA1)+'-'+str(gAMPA2)+'_gNMDA'+str(gNMDA1)+'-'+str(gNMDA2)+'_gGABA'+str(gGABA)+'_'+str(tauD)+'_figs.pdf')
